...
create table if not exists public.user_habits (
  ...
  reminder_time time,
  reminder_message text not null default '' check (char_length(reminder_message) <= 240),
  reminder_snooze_minutes integer not null default 30 check (reminder_snooze_minutes between 5 and 240),
